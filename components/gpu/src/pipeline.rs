use crate::vertex::{CircleVertex, TextVertex, Vertex};
pub struct RectPipeline {
    pub pipeline: wgpu::RenderPipeline,
    pub viewport_bind_group_layout: wgpu::BindGroupLayout,
}

/// Draws a fullscreen textured quad (used by the browser process to blit
/// frames composed by the GPU process onto the window surface).
pub struct ImagePipeline {
    pub pipeline: wgpu::RenderPipeline,
    pub bind_group_layout: wgpu::BindGroupLayout,
}

/// Draws arbitrary positioned RGBA textured quads (used for `<img>` elements).
...
impl CirclePipeline {
    pub fn new(device: &wgpu::Device, surface_format: wgpu::TextureFormat, viewport_bind_group_layout: &wgpu::BindGroupLayout) -> Self {
        let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: None,
...
impl RectPipeline {
    pub fn new(device: &wgpu::Device, surface_format: wgpu::TextureFormat) -> Self {
        ...
        Self { pipeline, viewport_bind_group_layout }
    }
}
